...
fn it_parses_big_float_string() {
    ...
    assert_eq!("79.22816251426433759354395033", a.to_string());
}
...
fn it_adds_decimals() {
    ...
    let tests = &[
        ...
        (
            ...
            either!("108053.275", "108053.27500000000000000000001"),
        ),
        (
...
fn it_subtracts_decimals() {
    ...
    let tests = &[
        ...
        ("-3", "2", "-5"),
        ("1.234", "2.4567", "-1.2227"),
        ("844.13000000", "843.65000000", "0.48"),
...
fn it_multiplies_decimals() {
    ...
    let tests = &[
        ...
        ("1", "2.01", "2.01"),
        ("1.0", "2.01", "2.01"),
        ("0.00000000000000001", "0.00000000000000001", "0"),
...
fn it_can_round_significant_figures() {
    let tests = &[
        ...
        ("305.459", 7, Some("305.459")),
        ("305.459", 10, Some("305.459")),
        ("-305.459", 3, Some("-305")),
...
fn it_can_parse_highly_significant_numbers() {
    let tests = &[
        ...
        ("11.1111111111111111111111111195", "11.11111111111111111111111112"),
        ("99.9999999999999999999999999995", "100"),
        ("-11.1111111111111111111111111195", "-11.11111111111111111111111112"),
        ("-99.9999999999999999999999999995", "-100"),
        ...
        (".00000000000000000000000000001", "0"),
        (".10000000000000000000000000000", "0.1"),
    ];
    for &(value, expected) in tests {
...
fn it_can_parse_different_radix() {
    let tests = &[
        ...
        // We limit to 28 dp
        ("843.6500000000000000000000000000", 10, true, "843.65"),
    ];
...
fn it_computes_equal_hashes_for_equal_values() {
    ...
    assert_eq!("1", map.get(&k3).expect("could not get k3"));
    assert_eq!(1, map.len());
    ...
    assert_eq!(2, map.len());
    assert_eq!("1", map.get(&k1).expect("could not get k1"));
}
...
mod issues {
    ...
    fn issue_384_neg_overflow_during_subtract_carry() {
        ...
        assert_eq!("-714606667614253123173036.8512", c.unwrap().to_string());
    }
